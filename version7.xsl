...
<body>
  ...
  <table border="1">
    ...
    <tr>
      ...
      <xsl:choose>
        <xsl:when test="(@name='hdds') or (@name='halld_recon') or (@name='halld_sim') or (@name='hdgeant4') or (@name='gluex_root_analysis') or (@name='hd_utilities') or (@name='diracxx') or (@name='gluex_MCWrapper') or (@name='gluex_MCWrapper')">
